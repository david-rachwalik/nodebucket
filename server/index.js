...
const server_addr = 'buwebdev-cluster-1.gfevl.mongodb.net';
const db_name = 'nodebucket';
const CONN = `mongodb+srv://${db_username}:${db_password}@${server_addr}/${db_name}?retryWrites=true&w=majority`;

// Establish database connection
mongoose
  .connect(CONN)
  .then(() => {
    console.log(`Successfully connected to '${db_name}' in MongoDB!`);
  })
  .catch((err) => {
